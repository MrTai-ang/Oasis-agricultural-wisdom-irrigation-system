<template>
    <div class="com-container" >
      <div class="com-chart" id="myChart6"  >
      ...
      methods:{
          ...
          drawCharts(){
              ...
              this.$echarts.registerTheme("purple",purple)//注册主题
               let myChart = this.$echarts.init(document.getElementById("myChart6"),'purple');
              //获取数据
              ...
              .then(res=>{
                  ...
                  {
                      y_hum1.push(all_data[i].hum1)
                //    这里的hum2还没有接在开发板上模拟一下
                      y_hum2.push(all_data[i].hum2-500)

                  }
                  console.log('y_hum1:',y_hum1)
              
                  console.log('y_hum2:',y_hum2)
